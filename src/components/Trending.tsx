...
const Trending = ({ onWishlistChange }: { onWishlistChange?: () => void }) => {
    ...
    return (
        <>
            <View style={styles.container}>
                <Text style={styles.trendingProductHeading}>Trending Products</Text>
                
                    <TouchableOpacity onPress={() => navigation.navigate('AllTrendingProducts')}>
                        <Text style={styles.trendingProductText}>View All</Text>
                    </TouchableOpacity>
            </View>

            <View style={styles.grid}>

                {productList.filter(p => p.trending).slice(0, 4).map((item) => {
                        ...
                        >
                            ...
                            {item.variations[0]?.stock > 0 ? (
                                <View style={styles.badge}>
                                    <Text style={styles.badgeText}>{item.trending ? "Trending" : ""}</Text>
                                </View>
                            ) : (
