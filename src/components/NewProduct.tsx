...
const NewProduct = ({ onWishlistChange }: { onWishlistChange?: () => void }) => {
    ...
    return (
        <>
            <View style={styles.container}>
                <Text style={styles.newProductHeading}>New Products</Text>

                <TouchableOpacity onPress={() => navigation.navigate('AllNewProducts')}>
                    <Text style={styles.newProductText}>View All</Text>
                </TouchableOpacity>
            ...
            <View style={styles.grid}>
                ...
                {productList.filter(p => p.new).slice(0, 4).map((item) => {
